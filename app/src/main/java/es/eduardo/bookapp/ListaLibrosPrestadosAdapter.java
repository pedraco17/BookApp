...
public class ListaLibrosPrestadosAdapter extends ArrayAdapter<Prestamo> {
    private Context context;
    private List<Prestamo> prestamos;

    public ListaLibrosPrestadosAdapter(Context context, List<Prestamo> prestamos) {
        super(context, R.layout.lista_libros_prestados, prestamos);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.lista_libros_prestados, parent, false);
        TextView tvIdUsuario = (TextView) rowView.findViewById(R.id.tvIdUsuario);
        ...
        tvIdUsuario.setText(prestamo.getIdUsuario() + "");
